  ...
  return (
    <div className="space-y-3 animate-in fade-in duration-150">
      ...
      <div className="space-y-2 py-2">
        ...
        <div className="flex flex-col gap-2 p-3 rounded-lg bg-bg-hover/50 border border-border-subtle text-xs transition-all duration-200">
            ...
            <div className="flex items-center gap-1.5 text-[12px]">
              {isSyncingRag ? (
                ...
                <>
                  ...
                  <span className="text-rose-600 dark:text-rose-400 font-medium">Sync Failed</span>
                </>
              ) : ragSyncStatus === 'out_of_sync' ? (
                <>
                  <AlertCircle size={13} className="text-amber-500" />
                  <span className="text-amber-600 dark:text-amber-400 font-medium">Needs Update</span>
                </>
              ) : (
                <>
          ...
          <div className="flex items-center gap-2 mt-1">
            <button
              ...
              className={twMerge(
                'flex-1 flex items-center justify-center gap-1.5 text-[11px] font-medium px-2.5 py-1.5 rounded-md transition-all duration-150 shadow-xs',
                isSyncingRag
                  ? 'bg-border-default text-text-muted cursor-not-allowed shadow-none'
                  : ragSyncStatus === 'synced'
                  ? 'bg-bg-primary text-text-muted border border-border-default shadow-none cursor-default opacity-70'
                  : ragSyncStatus === 'error'
            ...
            {ragSyncStatus && ragSyncStatus !== 'unprocessed' && (
              <button
                ...
                className={twMerge(
                  'flex items-center justify-center gap-1.5 text-[11px] font-medium px-2.5 py-1.5 rounded-md transition-all duration-150 cursor-pointer shadow-xs border',
                  isSyncingRag
                    ? 'bg-border-default border-transparent text-text-muted cursor-not-allowed shadow-none'
                    : 'bg-bg-primary hover:bg-red-500/10 border-border-default hover:border-red-500/30 text-text-muted hover:text-red-500'
                )}
