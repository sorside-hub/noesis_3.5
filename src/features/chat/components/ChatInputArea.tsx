  ...
  return (
    <div className="shrink-0 w-full px-4 pb-4 lg:pb-6 pt-2 bg-gradient-to-t from-bg-primary via-bg-primary/90 to-transparent">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-end gap-2 bg-bg-surface border border-border-default focus-within:border-accent-primary rounded-2xl p-2 px-4 shadow-md transition-all">
          <textarea
            ref={textareaRef}
            value={input}
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-text-primary text-bg-surface hover:opacity-90 disabled:opacity-30 transition-all cursor-pointer shrink-0 mb-0.5"
